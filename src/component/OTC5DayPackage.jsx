...
const OTC5DayPackage = () => {
  return (
    <div className="main-container-for-qnex-package-setup">
      <div className="card-wrapper-for-qnex-otc-package">
       
        <h1 style={{padding:"50px 20px 0px 20px"}} className="header-title-text-for-qnex-otc-package">
          QNEX OTC 5DAY PACKAGE
        </h1>
        <div className="item-payment-inner" style={{display:"flex", alignItems:"flex-end", borderBottom:"1px solid #D4D4D4", padding:"0px 20px 40px 20px"}}>
        ...
        <div className="pricing-information-for-qnex-package">USD 79</div>
      ...
      {/* Render child components (like PayToTrc20) here */}
      <Outlet />
    </div>
  );
};

export default OTC5DayPackage;
