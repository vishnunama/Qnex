...
<div style={{borderRadius:"20px"}}  className='tex-plan-mainner'>
    ...
    <div className='all-button-inner'>
         <div style={{width:"100%", maxWidth:"90px"}} className='button-inner-in'> 5 Days Plan</div>
    ...
    <Link to="/OTC5DayPackage" style={{border:" 2px solid #fff", width:"140px", textAlign:"center", borderRadius:"50px", padding:"15px 10px", fontWeight:"bold", marginTop:"40px", marginBottom:"20px", textDecoration:"none", color:"#fff", }}>BUY NOW <FaRegMoneyBill1 />
</Link>
    </div>
    <div >
